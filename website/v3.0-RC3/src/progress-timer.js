cc.ProgressTimer = cc.Node.extend({_type: null, _percentage: 0, _sprite: null, _midPoint: null, _barChangeRate: null, _reverseDirection: false, _className: "ProgressTimer", getMidpoint: function () {
    ...
    setReverseProgress: null, _setReverseProgressForCanvas: function (reverse) {
        ...
        var locSprite = this._sprite;
        if (locSprite._blendFuncStr != "source")context.globalCompositeOperation = locSprite._blendFuncStr;
        ...
        var flipXOffset =
            0 | locOffsetPosition.x, flipYOffset = -locOffsetPosition.y - locRect.height, locTextureCoord = locSprite._textureRect_Canvas;
