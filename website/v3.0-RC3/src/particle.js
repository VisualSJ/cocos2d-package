...
cc.ParticleSystem = cc.Node.extend({_plistFile: "", _elapsed: 0, _dontTint: false, modeA: null, modeB: null, _className: "ParticleSystem", _pointZeroForParticle: cc.p(0, 0), _particles: null, _emitCounter: 0, _particleIdx: 0, _batchNode: null, atlasIndex: 0, _transformSystemDirty: false, _allocatedParticles: 0, drawMode: null, shapeType: null, _isActive: false, particleCount: 0, duration: 0, _sourcePosition: null, _posVar: null, life: 0, lifeVar: 0, angle: 0, angleVar: 0, startSize: 0, startSizeVar: 0, endSize: 0, endSizeVar: 0, _startColor: null, _startColorVar: null,
    ...
    isAutoRemoveOnFinish: function () {
        ...
        if (cc._renderType === cc._RENDER_TYPE_CANVAS)if (this.particleCount < particles.length)particle =
            particles[this.particleCount]; else {
        ...
        particle.pos.y = this._sourcePosition.y + this._posVar.y *
            locRandomMinus11();
        var start, end;
        ...
        if (cc._renderType === cc._RENDER_TYPE_CANVAS) {
            start = cc.color(cc.clampf(locStartColor.r + locStartColorVar.r * locRandomMinus11(), 0, 255), cc.clampf(locStartColor.g + locStartColorVar.g * locRandomMinus11(), 0, 255), cc.clampf(locStartColor.b + locStartColorVar.b * locRandomMinus11(), 0, 255), cc.clampf(locStartColor.a + locStartColorVar.a * locRandomMinus11(),
                0, 255));
            ...
            start = {r: cc.clampf(locStartColor.r + locStartColorVar.r * locRandomMinus11(), 0, 255), g: cc.clampf(locStartColor.g + locStartColorVar.g * locRandomMinus11(), 0, 255), b: cc.clampf(locStartColor.b + locStartColorVar.b * locRandomMinus11(),
                0, 255), a: cc.clampf(locStartColor.a + locStartColorVar.a * locRandomMinus11(), 0, 255)};
        ...
        locParticleDeltaColor.r = (end.r -
            start.r) / locParticleTimeToLive;
        ...
        var a =
            cc.degreesToRadians(this.angle + this.angleVar * locRandomMinus11());
        if (this.emitterMode === cc.ParticleSystem.MODE_GRAVITY) {
            ...
            locParticleModeA.tangentialAccel = locModeA.tangentialAccel + locModeA.tangentialAccelVar *
                locRandomMinus11();
        ...
        if (this.positionType == cc.ParticleSystem.TYPE_FREE)cc.pIn(currentPosition, this.convertToWorldSpace(this._pointZeroForParticle));
        ...
        if (this._visible) {
            ...
            while (this._particleIdx < this.particleCount) {
                ...
                if (selParticle.timeToLive > 0) {
                    if (this.emitterMode ==
                        cc.ParticleSystem.MODE_GRAVITY) {
                        ...
                        cc.pMultIn(tmp, dt);
                        cc.pAddIn(selParticle.modeA.dir,
                            tmp);
                    ...
                    if (this._batchNode) {
                        this._batchNode.disableParticle(this.atlasIndex +
                            currentIndex);
