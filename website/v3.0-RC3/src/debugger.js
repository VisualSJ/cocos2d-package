...
cc._initDebugSetting = function (mode) {
    ...
    if (mode > ccGame.DEBUG_MODE_ERROR) {
        ...
        if (mode != ccGame.DEBUG_MODE_ERROR_FOR_WEB_PAGE)cc.warn = function () {
            locLog("WARN :  " + cc.formatStr.apply(cc,
                arguments))
        };
        if (mode == ccGame.DEBUG_MODE_INFO_FOR_WEB_PAGE)cc.log = function () {
        ...
        if (mode != ccGame.DEBUG_MODE_ERROR)cc.warn = function () {
            return console.warn.apply(console, arguments)
        };
        if (mode == ccGame.DEBUG_MODE_INFO)cc.log = function () {
