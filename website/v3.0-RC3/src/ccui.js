...
ccui.Widget = ccui.ProtectedNode.extend({_enabled: true, _bright: true, _touchEnabled: false, _brightStyle: null, _touchBeganPosition: null, _touchMovePosition: null, _touchEndPosition: null, _touchEventListener: null, _touchEventSelector: null, _name: "default", _widgetType: null, _actionTag: 0, _customSize: null, _layoutParameterDictionary: null, _layoutParameterType: 0, _focused: false, _focusEnabled: true, _ignoreSize: false, _affectByClipping: false, _sizeType: null, _sizePercent: null, _positionType: null, _positionPercent: null, _reorderWidgetChildDirty: false,
    ...
    _isAncestorsEnabled: function () {
        ...
        this._highlight =
            highlight;
        if (this._bright)if (this._highlight)this.setBrightStyle(ccui.Widget.BRIGHT_STYLE_HIGH_LIGHT); else this.setBrightStyle(ccui.Widget.BRIGHT_STYLE_NORMAL); else this._onPressStateChangedToDisabled()
    }, isFocused: function () {
    ...
    _updateFlippedX: function () {
        ...
        type =
            type || this._layoutParameterType;
        ...
        for (var i = 0; i < widgetChildren.length; i++) {
            ...
            if (locChild instanceof
                ccui.Widget)this.addChild(locChild.clone())
        }
...
ccui.Scale9Sprite = cc.Node.extend({_spriteRect: null, _capInsetsInternal: null, _positionsAreDirty: false, _scale9Image: null, _topLeft: null, _top: null, _topRight: null, _left: null, _centre: null, _right: null, _bottomLeft: null, _bottom: null, _bottomRight: null, _cacheSprite: null, _cacheCanvas: null, _cacheContext: null, _cacheTexture: null, _scale9Dirty: true, _opacityModifyRGB: false, _originalSize: null, _preferredSize: null, _opacity: 0, _color: null, _capInsets: null, _insetLeft: 0, _insetTop: 0, _insetRight: 0, _insetBottom: 0, _spritesGenerated: false,
    _spriteFrameRotated: false, _textureLoaded: false, _loadedEventListeners: null, _className: "Scale9Sprite", textureLoaded: function () {
        ...
        if (locInsetLeft === 0 && locInsetTop === 0 && locInsetRight === 0 && locInsetBottom === 0)insets = cc.rect(0, 0, 0, 0); else insets = this._spriteFrameRotated ? cc.rect(locInsetBottom, locInsetLeft, locSpriteRect.width - locInsetRight - locInsetLeft, locSpriteRect.height - locInsetTop - locInsetBottom) : cc.rect(locInsetLeft,
            locInsetTop, locSpriteRect.width - locInsetLeft - locInsetRight, locSpriteRect.height - locInsetTop - locInsetBottom);
        ...
        var locTopLeftContentSize =
            locTopLeft.getContentSize();
        ...
        var rescaledHeight = locCenterContentSize.height *
            verticalScale;
        ...
        cc.view._resetScale();
        if (contentSizeChanged)this._cacheSprite.setTextureRect(cc.rect(0,
            0, size.width, size.height));
        if (!this._cacheSprite.getParent())this.addChild(this._cacheSprite)
        ...
        if (file != undefined)if (file instanceof cc.SpriteFrame)this.initWithSpriteFrame(file, rect); else {
            ...
            if (frame != null)this.initWithSpriteFrame(frame, rect); else this.initWithFile(file,
                rect, capInsets)
        } else this.init()
        ...
        for (var i = 0; i < scaleChildren.length; i++) {
            var selChild = scaleChildren[i];
            if (selChild)if (cc._renderType === cc._RENDER_TYPE_CANVAS) {
                cc.Node.prototype.updateDisplayedColor.call(selChild, parentColor);
                if (parentColor.r !== 255 || parentColor.g !== 255 || parentColor.b !== 255) {
                    selChild._changeTextureColor();
                    selChild._setNodeDirtyForCache()
                }
            } else selChild.updateDisplayedColor(parentColor)
        }
        this._scale9Dirty =
            true
    ...
    setInsetTop: function (insetTop) {
        ...
        return this.initWithBatchNode(null, cc.rect(0, 0, 0, 0), false, cc.rect(0,
            0, 0, 0))
        ...
        if (!file)throw"ccui.Scale9Sprite.initWithFile(): file should be non-null";
        var texture = cc.textureCache.getTextureForKey(file);
        if (!texture)texture = cc.textureCache.addImage(file);
        ...
        if (!locLoaded)texture.addLoadedEventListener(function (sender) {
            ...
            this.updateWithBatchNode(this._scale9Image,
                cc.rect(0, 0, size.width, size.height), false, this._capInsets);
        ...
        if (!spriteFrame || !spriteFrame.getTexture())throw"ccui.Scale9Sprite.initWithSpriteFrame(): spriteFrame should be non-null and its texture should be non-null";
        capInsets = capInsets || cc.rect(0, 0, 0, 0);
        var locLoaded =
        ...
        if (!spriteFrameName)throw"ccui.Scale9Sprite.initWithSpriteFrameName(): spriteFrameName should be non-null";
        capInsets = capInsets || cc.rect(0, 0, 0, 0);
    ...
    isOpacityModifyRGB: function () {
        ...
        x += center_w;
        var rightcenterbounds =
            cc.rect(x + 0.5 | 0, y + 0.5 | 0, right_w + 0.5 | 0, center_h + 0.5 | 0);
        x = 0;
        y = 0;
        y += top_h;
        y += center_h;
        ...
        if (!rotated) {
            ...
            locScale9Image.addChild(this._right, 1, ccui.Scale9Sprite.POSITIONS_RIGHT);
            this._topLeft = new cc.Sprite;
            this._topLeft.initWithTexture(selTexture, rotatedlefttopbounds,
                true);
            locScale9Image.addChild(this._topLeft, 2, ccui.Scale9Sprite.POSITIONS_TOPLEFT);
            this._topRight = new cc.Sprite;
        ...
        if (cc._renderType === cc._RENDER_TYPE_WEBGL)this.addChild(locScale9Image);
    ...
    setBackGroundImage: function (fileName, texType) {
        ...
        switch (this._colorType) {
            ...
            case ccui.Layout.BG_COLOR_SOLID:
                ...
                break;
            case ccui.Layout.BG_COLOR_GRADIENT:
                this._gradientRender = new cc.LayerGradient(cc.color(255, 0, 0, 255), cc.color(0,
                    255, 0, 255));
...
ccui.HBox = ccui.Layout.extend({ctor: function (size) {
    if (size)this.initWithSize(size); else this.init()
}, init: function () {
...
ccui.CheckBox = ccui.Widget.extend({_backGroundBoxRenderer: null, _backGroundSelectedBoxRenderer: null, _frontCrossRenderer: null, _backGroundBoxDisabledRenderer: null, _frontCrossDisabledRenderer: null, _isSelected: true, _checkBoxEventListener: null, _checkBoxEventSelector: null, _checkBoxEventCallback: null, _backGroundTexType: ccui.Widget.LOCAL_TEXTURE, _backGroundSelectedTexType: ccui.Widget.LOCAL_TEXTURE, _frontCrossTexType: ccui.Widget.LOCAL_TEXTURE, _backGroundDisabledTexType: ccui.Widget.LOCAL_TEXTURE, _frontCrossDisabledTexType: ccui.Widget.LOCAL_TEXTURE,
    _backGroundFileName: "", _backGroundSelectedFileName: "", _frontCrossFileName: "", _backGroundDisabledFileName: "", _frontCrossDisabledFileName: "", _className: "CheckBox", _backGroundBoxRendererAdaptDirty: true, _backGroundSelectedBoxRendererAdaptDirty: true, _frontCrossRendererAdaptDirty: true, _backGroundBoxDisabledRendererAdaptDirty: true, _frontCrossDisabledRendererAdaptDirty: true, ctor: function (backGround, backGroundSelected, cross, backGroundDisabled, frontCrossDisabled, texType) {
        ...
        if (ccui.Widget.prototype.init.call(this)) {
            ...
            if (backGround === undefined)this.loadTextures(backGround, backGroundSelected, cross, backGroundDisabled, frontCrossDisabled, texType);
            return true
        }
        return false
    }, _initRenderer: function () {
...
ccui.ImageView = ccui.Widget.extend({_scale9Enabled: false, _prevIgnoreSize: true, _capInsets: null, _imageRenderer: null, _textureFile: "", _imageTexType: ccui.Widget.LOCAL_TEXTURE, _imageTextureSize: null, _className: "ImageView", _imageRendererAdaptDirty: true, ctor: function (imageFileName, texType) {
    ...
    if (this._scale9Enabled)this._imageRenderer = new ccui.Scale9Sprite; else this._imageRenderer = cc.Sprite.create();
    ...
    setPercent: function (percent) {
        ...
        switch (this._direction) {
            case ccui.LoadingBar.TYPE_LEFT:
                ...
                break;
            case ccui.LoadingBar.TYPE_RIGHT:
                locBarRender.setPosition(this._totalLength, locContentSize.height *
                    0.5);
                break;
            default:
                break
        ...
        if (loadingBar instanceof ccui.LoadingBar) {
            ...
            this.loadTexture(loadingBar._textureFile,
...
ccui._TextFieldRenderer = cc.TextFieldTTF.extend({_maxLengthEnabled: false, _maxLength: 0, _passwordEnabled: false, _passwordStyleText: "", _attachWithIME: false, _detachWithIME: false, _insertText: false, _deleteBackward: false, _className: "_TextFieldRenderer", _textFieldRendererAdaptDirty: true, ctor: function () {
...
ccui.TextField = ccui.Widget.extend({_textFieldRenderer: null, _touchWidth: 0, _touchHeight: 0, _useTouchArea: false, _textFieldEventListener: null, _textFieldEventSelector: null, _passwordStyleText: "", _textFieldRendererAdaptDirty: true, _fontName: "", _fontSize: 12, ctor: function (placeholder, fontName, fontSize) {
    ccui.Widget.prototype.ctor.call(this);
    ...
    _attachWithIMEEvent: function () {
        ...
        if (this._eventCallback)this._eventCallback(this, ccui.TextField.EVENT_ATTACH_WITH_IME)
...
ccui.RichText = ccui.Widget.extend({_formatTextDirty: false, _richElements: null, _elementRenders: null, _leftSpaceWidth: 0, _verticalSpace: 0, _elementRenderersContainer: null, ctor: function () {
    ...
    var newContentSizeHeight = 0, locRenderersContainer =
        this._elementRenderersContainer;
    ...
    if (this._ignoreSize) {
        ...
        locRenderersContainer.setContentSize(newContentSizeWidth,
...
ccui.ScrollView = ccui.Layout.extend({_innerContainer: null, direction: null, _autoScrollDir: null, _topBoundary: 0, _bottomBoundary: 0, _leftBoundary: 0, _rightBoundary: 0, _bounceTopBoundary: 0, _bounceBottomBoundary: 0, _bounceLeftBoundary: 0, _bounceRightBoundary: 0, _autoScroll: false, _autoScrollAddUpTime: 0, _autoScrollOriginalSpeed: 0, _autoScrollAcceleration: 0, _isAutoScrollSpeedAttenuated: false, _needCheckAutoScrollDestination: false, _autoScrollDestination: null, _bePressed: false, _slidTime: 0, _moveChildPoint: null, _childFocusCancelOffset: 0,
    ...
    _bounceChildren: function (dt) {
        ...
        this._startAutoScrollChildrenWithOriginalSpeed(dir,
            orSpeed, attenuated, acceleration)
        ...
        switch (this.direction) {
            case ccui.ScrollView.DIR_VERTICAL:
                ...
                break;
            case ccui.ScrollView.DIR_HORIZONTAL:
                scrollEnabled = this._scrollChildrenHorizontal(touchOffsetX,
                    touchOffsetY);
                break;
            case ccui.ScrollView.DIR_BOTH:
        ...
        if (this.bounceEnabled)if (touchOffsetX > 0 && touchOffsetY > 0) {
            icLeftPos = locContainer.getLeftBoundary();
            if (icLeftPos + touchOffsetX >= this._bounceLeftBoundary) {
                realOffsetX = this._bounceLeftBoundary -
                    icLeftPos;
                this._scrollToLeftEvent();
                scrollEnabled = false
            }
        ...
        this._startAutoScrollChildrenWithDestination(cc.p(this._contentSize.width - this._innerContainer.getContentSize().width,
            this._innerContainer.getPositionY()), time, attenuated)
        ...
        this._startAutoScrollChildrenWithDestination(cc.p(this._contentSize.width -
            this._innerContainer.getContentSize().width, 0), time, attenuated)
        ...
        this._startAutoScrollChildrenWithDestination(cc.p(-(percent *
            w / 100), this._innerContainer.getPositionY()), time, attenuated)
        ...
        var w = this._innerContainer.getContentSize().width -
        ...
        var pass =
            ccui.Layout.prototype.onTouchBegan.call(this, touch, event);
        ...
        if (this._scrollViewEventListener && this._scrollViewEventSelector)this._scrollViewEventSelector.call(this._scrollViewEventListener,
            this, ccui.ScrollView.EVENT_SCROLLING);
        if (this._eventCallback)this._eventCallback(this, ccui.ScrollView.EVENT_SCROLLING)
    }, _bounceTopEvent: function () {
        if (this._scrollViewEventListener && this._scrollViewEventSelector)this._scrollViewEventSelector.call(this._scrollViewEventListener, this, ccui.ScrollView.EVENT_BOUNCE_TOP);
        if (this._eventCallback)this._eventCallback(this, ccui.ScrollView.EVENT_BOUNCE_TOP)
    }, _bounceBottomEvent: function () {
        if (this._scrollViewEventListener && this._scrollViewEventSelector)this._scrollViewEventSelector.call(this._scrollViewEventListener,
            this, ccui.ScrollView.EVENT_BOUNCE_BOTTOM);
        ...
        if (this._scrollViewEventListener && this._scrollViewEventSelector)this._scrollViewEventSelector.call(this._scrollViewEventListener,
            this, ccui.ScrollView.EVENT_BOUNCE_RIGHT);
...
ccui.PageView = ccui.Layout.extend({_curPageIdx: 0, _pages: null, _touchMoveDirection: null, _touchStartLocation: 0, _touchMoveStartLocation: 0, _movePagePoint: null, _leftBoundaryChild: null, _rightBoundaryChild: null, _leftBoundary: 0, _rightBoundary: 0, _isAutoScrolling: false, _autoScrollDistance: 0, _autoScrollSpeed: 0, _autoScrollDirection: 0, _childFocusCancelOffset: 0, _pageViewEventListener: null, _pageViewEventSelector: null, _className: "PageView", _eventCallback: null, ctor: function () {
    ...
    removePageAtIndex: function (index) {
        ...
        if (index <
            0 || index >= this.getPages().size())return null;
